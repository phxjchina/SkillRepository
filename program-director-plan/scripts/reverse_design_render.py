...
PROFS = [
  ...
  ]},
 {
  ...
  "systems":[
   ...
   {"id":"Z2","name":"自主导航与控制系统","job":"自主系统工程师",
    "subs":[
      {"name":"导航定位","funcs":[
   ...
   {"id":"Z3","name":"低空安全防护与目标反制系统","job":"低空安全工程师",
    "subs":[
      {"name":"目标探测","funcs":[
   ...
   {"id":"Z4","name":"边缘智能嵌入式系统","job":"边缘智能系统工程师",
    "subs":[
      {"name":"综合实验(Jetson)","funcs":[
        {"f":"边缘AI部署综合实验","kp":"边缘部署 / 集成","c":"航空智能嵌入式系统综合实验 S6"},
        {"f":"嵌入式仿真联调","kp":"仿真联调","c":"学院嵌入式仿真平台(综合实验)"}]}]},
   {"id":"Z5","name":"智能系统集成与综合实验平台","job":"系统集成工程师",
    "subs":[
      ...
      {"name":"综合实验台","funcs":[
        ...
        {"f":"安全防护综合实验平台","kp":"平台集成","c":"学院安全防护综合实验平台"}]}]},
...
CROSS = [
 ...
 ("Z10","Z2","物理AI数字孪生用于自主系统控制仿真"),
 ("Z8","Z4","智能机器人控制依赖智科边缘智能硬件"),
